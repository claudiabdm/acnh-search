export const bugs = {
  "common_butterfly": {
    ...
    "name": {
      "name-en": "Common butterfly",
      "name-cn": "白粉蝶",
      "name-de": "Kohlweißling",
      "name-sp": "Mariposa común",
      "name-fr": "Piéride de la rave",
      "name-it": "Farfalla comune",
      "name-jp": "モンシロチョウ",
      "name-kr": "배추흰나비",
      "name-nl": "Koolwitje",
      "name-ru": "Белянка"
    ...
    "museumPhrase": "The common butterfly would have you believe it is but a beautiful friend flitting prettily about the flowers. Bah, I say! They 5 seem innocent things with their pretty white wings, but they hide a dark side! The common butterfly caterpillar is called a cabbage worm, you see, and it's a most voracious pest. The ravenous beasts chew through cabbage, broccoli, kale and the like with a devastating gusto. And my feathers! Their green coloring is truly GROSS! A hoo-rrific hue, I say."
  },
  "yellow_butterfly": {
    "id": 2,
    "fileName": "yellow_butterfly",
    "name": {
      "name-en": "Yellow butterfly",
      "name-cn": "斑缘点粉蝶",
      "name-de": "Zitronenfalter",
      "name-sp": "Mariposa colias",
      "name-fr": "Citrin",
      "name-it": "Farfalla gialla",
      "name-jp": "モンキチョウ",
      "name-kr": "노랑나비",
      "name-nl": "Citroenvlinder",
      "name-ru": "Желтушка"
    },
    "availability": {
      "monthNorthern": "3-6 & 9-10",
      "monthSouthern": "9-12 & 3-4",
      "time": "4am - 7pm",
      "isAllDay": false,
      "isAllYear": false,
      "location": "Flying",
  ...
  "tiger_butterfly": {
    ...
    "name": {
      "name-en": "Tiger butterfly",
      "name-cn": "凤蝶",
      "name-de": "Schwalbenschwanz",
      "name-sp": "Mariposa tigre",
      "name-fr": "Machaon",
      "name-it": "Farfalla tigre",
      "name-jp": "アゲハチョウ",
      "name-kr": "호랑나비",
      "name-nl": "Koninginnenpage",
      "name-ru": "Махаон"
    },
    "availability": {
      "monthNorthern": "3-9",
    ...
    "museumPhrase": "Tiger butterflies are known for their majestic wings, which many consider quite beautiful. Truth be told, I find them monstrous! Those strange striped patterns... They give this owl the goose bumps! And while you 5 imagine young tiger butterfly larvae to look like lovely green caterpillars...it's not so! Why, when tiger butterflies are but babes, they're covered in unsightly white, brown, and black spots. In this way, they camouflage themselves as...as...bird droppings! Putrid pests, indeed!"
  },
  "peacock_butterfly": {
    "id": 4,
    "fileName": "peacock_butterfly",
    "name": {
      "name-en": "Peacock butterfly",
      "name-cn": "乌鸦凤蝶",
      "name-de": "Ritterfalter",
      "name-sp": "Mariposa bianor",
      "name-fr": "Papilio bianor",
      "name-it": "Farfalla vanessa io",
      "name-jp": "カラスアゲハ",
      "name-kr": "제비나비",
      "name-nl": "Pauwenpage",
      "name-ru": "Бианор"
    ...
    "museumPhrase": "Pretty as a peacock? Bah, I say! The wings of the peacock butterfly 5 have a pattern similar to that of the beautiful bird... But its forewings are also often covered in a dark, velvety hair! You heard right! HAIRY wings! A hair-raising revelation indeed!"
  },
  "common_bluebottle": {
    "id": 5,
    "fileName": "common_bluebottle",
    "name": {
      "name-en": "Common bluebottle",
      "name-cn": "青带凤蝶",
      "name-de": "Kolibrifalter",
      "name-sp": "Mariposa triángulo azul",
      "name-fr": "Graphium sarpedon",
      "name-it": "Graphium sarpedon",
      "name-jp": "アオスジアゲハ",
      "name-kr": "청띠제비나비",
      "name-nl": "Blauwe driehoek",
      "name-ru": "Графиум сарпедон"
    },
    "availability": {
      "monthNorthern": "4-8",
      "monthSouthern": "9-2",
  ...
  "paper_kite_butterfly": {
    ...
    "name": {
      "name-en": "Paper kite butterfly",
      "name-cn": "大白斑蝶",
      "name-de": "Weiße",
      "name-sp": "Mariposa cometa de papel",
      "name-fr": "Grand planeur",
      "name-it": "Farfalla carta di riso",
      "name-jp": "オオゴマダラ",
      "name-kr": "왕얼룩나비",
      "name-nl": "Papiervlinder",
      "name-ru": "Идея левконоя"
    },
    "availability": {
      "monthNorthern": "",
      "monthSouthern": "",
  ...
  "great_purple_emperor": {
    ...
    "name": {
      "name-en": "Great purple emperor",
      "name-cn": "大紫蛱蝶",
      "name-de": "Japan-Schillerfalter",
      "name-sp": "Marip. emperador japonés",
      "name-fr": "Sasakia charonda",
      "name-it": "Farfalla imperatore viola",
      "name-jp": "オオムラサキ",
      "name-kr": "왕오색나비",
      "name-nl": "Paarse keizervlinder",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "5-8",
  ...
  "monarch_butterfly": {
    ...
    "name": {
      "name-en": "Monarch butterfly",
      "name-cn": "大桦斑蝶",
      "name-de": "Monarchfalter",
      "name-sp": "Mariposa monarca",
      "name-fr": "Monarque",
      "name-it": "Farfalla monarca",
      "name-jp": "オオカバマダラ",
      "name-kr": "왕나비",
      "name-nl": "Monarchvlinder",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "9-11",
  ...
  "emperor_butterfly": {
    ...
    "name": {
      "name-en": "Emperor butterfly",
      "name-cn": "大蓝闪蝶",
      "name-de": "Himmelsfalter",
      "name-sp": "Mariposa celeste",
      "name-fr": "Morpho bleu",
      "name-it": "Farfalla morfo blu",
      "name-jp": "モルフォチョウ",
      "name-kr": "몰포나비",
      "name-nl": "Blauwe morpho",
      "name-ru": "Морфо менелай"
    },
    "availability": {
      "monthNorthern": "6-9 & 12-3",
      "monthSouthern": "6-9 & 12-3",
      "time": "5pm - 8am",
      "isAllDay": false,
      "isAllYear": false,
      "location": "Flying",
  ...
  "agrias_butterfly": {
    ...
    "name": {
      "name-en": "Agrias butterfly",
      "name-cn": "彩袄蛱蝶",
      "name-de": "Agrias-Falter",
      "name-sp": "Mariposa narciso",
      "name-fr": "Agrias",
      "name-it": "Farfalla agrias",
      "name-jp": "ミイロタテハ",
      "name-kr": "아그리아스나비",
      "name-nl": "Agriasvlinder",
      "name-ru": "Агриас клаудина"
    },
    "availability": {
      "monthNorthern": "4-9",
      "monthSouthern": "10-3",
    ...
    "museumPhrase": "Some say the agrias butterfly is one of the most beautiful butterflies in the world. Bah, I say! BAH! They 5 have brightly colored wings, but the way they flutter and flitter...SO FOUL! In fact, the agrias butterfly flies so fast, it is quite a feat to catch one. I suppose I should congratulate you on your good fortune... But catching any bug seems a misfortune to me."
  },
  "rajah_brookes_birdwing": {
    "id": 11,
    "fileName": "rajah_brookes_birdwing",
    "name": {
      "name-en": "Rajah Brooke's birdwing",
      "name-cn": "红颈凤蝶",
      "name-de": "Troides brookiana",
      "name-sp": "Mariposa alas de Brooke",
      "name-fr": "Troides brookiana",
      "name-it": "Farfalla Raja Brooke",
      "name-jp": "アカエリトリバネアゲハ",
      "name-kr": "붉은목도리비단나비",
      "name-nl": "Rajah Brooke-vlinder",
      "name-ru": "Трогоноптера Брука"
    },
    "availability": {
      "monthNorthern": "4-9 & 12-2",
      "monthSouthern": "6-8 & 10-3",
      "time": "8am - 5pm",
      "isAllDay": false,
      "isAllYear": false,
      "location": "Flying",
  ...
  "queen_alexandras_birdwing": {
    ...
    "name": {
      "name-en": "Queen Alexandra's birdwing",
      "name-cn": "亚历山大凤蝶",
      "name-de": "Vogelfalter",
      "name-sp": "Mariposa alas de pájaro",
      "name-fr": "Troides alexandrae",
      "name-it": "Farfalla regina Alessandra",
      "name-jp": "アレキサンドラトリバネアゲハ",
      "name-kr": "알렉산드라비단제비나비",
      "name-nl": "Alexandra's vogelvlinder",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "5-9",
  ...
  "moth": {
    ...
    "name": {
      ...
      "name-de": "Motte",
      "name-sp": "Polilla",
      "name-fr": "Papillon de nuit",
      "name-it": "Falena",
      "name-jp": "ガ",
      "name-kr": "나방",
      "name-nl": "Mot",
      "name-ru": "Павлиноглазка"
    },
    "availability": {
      "monthNorthern": "",
      "monthSouthern": "",
  ...
  "atlas_moth": {
    ...
    "name": {
      "name-en": "Atlas moth",
      "name-cn": "皇蛾",
      "name-de": "Atlasspinner",
      "name-sp": "Polilla atlas",
      "name-fr": "Attacus Atlas",
      "name-it": "Farfalla cobra",
      "name-jp": "ヨナグニサン",
      "name-kr": "아틀라스나방",
      "name-nl": "Atlasvlinder",
      "name-ru": "Павлиноглазка атлас"
    },
    "availability": {
      "monthNorthern": "4-9",
      "monthSouthern": "10-3",
  ...
  "madagascan_sunset_moth": {
    ...
    "name": {
      "name-en": "Madagascan sunset moth",
      "name-cn": "日落蛾",
      "name-de": "Regenbogenfalter",
      "name-sp": "Polilla crepuscular",
      "name-fr": "Chrysiridia rhipheus",
      "name-it": "Urania del Madagascar",
      "name-jp": "ニシキオオツバメガ",
      "name-kr": "마다가스카르비단제비나방",
      "name-nl": "Adriandolo",
      "name-ru": "Урания мадагаскарская"
    },
    "availability": {
      "monthNorthern": "4-9",
      "monthSouthern": "10-3",
  ...
  "long_locust": {
    ...
    "name": {
      "name-en": "Long locust",
      "name-cn": "中华剑角蝗",
      "name-de": "Nasenschrecke",
      "name-sp": "Langosta alargada",
      "name-fr": "Acrida cinerea",
      "name-it": "Acrida cinerea",
      "name-jp": "ショウリョウバッタ",
      "name-kr": "방아깨비",
      "name-nl": "Veldsprinkhaan",
      "name-ru": "Акрида"
    },
    "availability": {
      "monthNorthern": "4-11",
  ...
  "migratory_locust": {
    ...
    "name": {
      "name-en": "Migratory locust",
      "name-cn": "飞蝗",
      "name-de": "Wanderschrecke",
      "name-sp": "Langosta migratoria",
      "name-fr": "Criquet pèlerin",
      "name-it": "Locusta migratoria",
      "name-jp": "トノサマバッタ",
      "name-kr": "섬풀무치",
      "name-nl": "Treksprinkhaan",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "8-11",
    ...
    "museumPhrase": "As if the average locust weren't large enough...we must suffer the long locust too! The wretched beasts are known for their unusually long hind legs as well as their elongated heads. But that is hardly the long locusts' worst trait... I tell you, they spit brown goo when they're scared! Revolting behavior indeed! Ugh and ewww!"
  },
  "rice_grasshopper": {
    "id": 18,
    "fileName": "rice_grasshopper",
    "name": {
      "name-en": "Rice grasshopper",
      "name-cn": "稻蝗",
      "name-de": "Heuschrecke",
      "name-sp": "Langosta",
      "name-fr": "Criquet",
  ...
  "cricket": {
    ...
    "name": {
      ...
      "name-cn": "蟋蟀",
      "name-de": "Grille",
      "name-sp": "Grillo común",
      "name-fr": "Grillon des prés",
      "name-it": "Grillo",
      "name-jp": "コオロギ",
      "name-kr": "귀뚜라미",
      "name-nl": "Krekel",
  ...
  "bell_cricket": {
    ...
    "name": {
      "name-en": "Bell cricket",
      "name-cn": "铃虫",
      "name-de": "Singgrille",
      "name-sp": "Grillo campana",
      "name-fr": "Grillon du Midi",
      "name-it": "Suzumushi",
      "name-jp": "スズムシ",
      "name-kr": "방울벌레",
      "name-nl": "Belkrekel",
  ...
  "mantis": {
    ...
    "name": {
      "name-en": "Mantis",
      "name-cn": "螳螂",
      "name-de": "Gottesanbeterin",
      "name-sp": "Mantis religiosa",
      "name-fr": "Mante religieuse",
      "name-it": "Mantide",
      "name-jp": "カマキリ",
      "name-kr": "사마귀",
      "name-nl": "Bidsprinkhaan",
      "name-ru": "Богомол"
    },
    "availability": {
      "monthNorthern": "3-11",
  ...
  "orchid_mantis": {
    ...
    "name": {
      "name-en": "Orchid mantis",
      "name-cn": "兰花螳螂",
      "name-de": "Orchideenmantis",
      "name-sp": "Mantis orquídea",
      "name-fr": "Mante orchidée",
      "name-it": "Mantide orchidea",
      "name-jp": "ハナカマキリ",
      "name-kr": "연꽃사마귀",
      "name-nl": "Orchidee-bidsprinkhaan",
      "name-ru": "Орхидейный богомол"
    },
    "availability": {
      "monthNorthern": "3-11",
      "monthSouthern": "9-5",
  ...
  "honeybee": {
    ...
    "name": {
      ...
      "name-cn": "蜜蜂",
      "name-de": "Honigbiene",
      "name-sp": "Abeja melífera",
      "name-fr": "Abeille naine",
      "name-it": "Ape operaia",
      "name-jp": "ミツバチ",
      "name-kr": "꿀벌",
      "name-nl": "Honingbij",
      "name-ru": "Восковая пчела"
    },
    "availability": {
      "monthNorthern": "3-7",
      "monthSouthern": "9-1",
  ...
  "brown_cicada": {
    ...
    "name": {
      "name-en": "Brown cicada",
      "name-cn": "油蝉",
      "name-de": "Braunzikade",
      "name-sp": "Cigarra marrón",
      "name-fr": "Cigale cercope",
      "name-it": "Cicala marrone",
      "name-jp": "アブラゼミ",
      "name-kr": "유지매미",
      "name-nl": "Bruine cicade",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-8",
  ...
  "robust_cicada": {
    ...
    "name": {
      "name-en": "Robust cicada",
      "name-cn": "斑透翅蝉",
      "name-de": "Hyalessa-Zikade",
      "name-sp": "Cigarra oriental",
      "name-fr": "Cigale hyalessa",
      "name-it": "Cicala robusta",
      "name-jp": "ミンミンゼミ",
      "name-kr": "참매미",
      "name-nl": "Minmin-cicade",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-8",
  ...
  "giant_cicada": {
    ...
    "name": {
      "name-en": "Giant cicada",
      "name-cn": "熊蝉",
      "name-de": "Riesenzikade",
      "name-sp": "Cigarra gigante",
      "name-fr": "Cigale géante",
      "name-it": "Cicala gigante",
      "name-jp": "クマゼミ",
      "name-kr": "곰매미",
      "name-nl": "Reuzencicade",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-8",
  ...
  "walker_cicada": {
    ...
    "name": {
      "name-en": "Walker cicada",
      "name-cn": "寒蝉",
      "name-de": "Bergzikade",
      "name-sp": "Cigarra común",
      "name-fr": "Cigale cicadelle",
      "name-it": "Cicala sputacchina",
      "name-jp": "ツクツクホウシ",
      "name-kr": "애매미",
      "name-nl": "Bergcicade",
      "name-ru": "Unknown"
  ...
  "evening_cicada": {
    ...
    "name": {
      "name-en": "Evening cicada",
      "name-cn": "暮蝉",
      "name-de": "Abendzikade",
      "name-sp": "Cigarrilla",
      "name-fr": "Cigale higurashi",
      "name-it": "Cicala notturna",
      "name-jp": "ヒグラシ",
      "name-kr": "쓰르라미",
      "name-nl": "Avondcicade",
      "name-ru": "Unknown"
  ...
  "cicada_shell": {
    ...
    "name": {
      "name-en": "Cicada shell",
      "name-cn": "蝉蜕",
      "name-de": "Zikadenlarvenhaut",
      "name-sp": "Muda de cigarra",
      "name-fr": "Mue de cigale",
      "name-it": "Esuvia di cicala",
      "name-jp": "セミのぬけがら",
      "name-kr": "매미 허물",
      "name-nl": "Cicadehuid",
      "name-ru": "Unknown"
  ...
  "red_dragonfly": {
    ...
    "name": {
      "name-en": "Red dragonfly",
      "name-cn": "红蜻蜓",
      "name-de": "Feuerlibelle",
      "name-sp": "Libélula roja",
      "name-fr": "Sympetrum",
      "name-it": "Libellula rossa",
      "name-jp": "アキアカネ",
      "name-kr": "고추잠자리",
      "name-nl": "Rode libel",
      "name-ru": "Unknown"
  ...
  "darner_dragonfly": {
    ...
    "name": {
      "name-en": "Darner dragonfly",
      "name-cn": "绿胸晏蜓",
      "name-de": "Königslibelle",
      "name-sp": "Libélula caballito del diablo",
      "name-fr": "Anax napolitain",
      "name-it": "Libellula depressa",
      "name-jp": "ギンヤンマ",
      "name-kr": "왕잠자리",
      "name-nl": "Zuidelijke keizerlibel",
      "name-ru": "Дозорщик"
    },
    "availability": {
      "monthNorthern": "4-10",
  ...
  "banded_dragonfly": {
    ...
    "name": {
      "name-en": "Banded dragonfly",
      "name-cn": "无霸勾蜓",
      "name-de": "Quelljungfer",
      "name-sp": "Libélula tigre",
      "name-fr": "Cordulégastre",
      "name-it": "Libellula striata",
      "name-jp": "オニヤンマ",
      "name-kr": "장수잠자리",
      "name-nl": "Bronlibel",
      "name-ru": "Unknown"
  ...
  "damselfly": {
    ...
    "name": {
      "name-en": "Damselfly",
      "name-cn": "豆娘",
      "name-de": "Wasserjungfer",
      "name-sp": "Libélula damisela",
      "name-fr": "Demoiselle",
      "name-it": "Zigottero",
      "name-jp": "イトトンボ",
      "name-kr": "실잠자리",
  ...
  "mole_cricket": {
    ...
    "name": {
      "name-en": "Mole cricket",
      "name-cn": "蝼蛄",
      "name-de": "Maulwurfsgrille",
      "name-sp": "Grillo cebollero",
      "name-fr": "Taupe-grillon",
      "name-it": "Grillotalpa",
      "name-jp": "オケラ",
      "name-kr": "땅강아지",
      "name-nl": "Veenmol",
    ...
    "museumPhrase": "Be warned, there is nowhere one might hide from the mole cricket. This plump pest has powerful front claws made for digging holes, and oh how it loves to burrow underground! A cousin to the grasshopper, it also has wings and can easily take to the air. And I swear this on my pinfeathers... Some have even been seen walking on water! Oh mercy, I 5 need a moment. This is making me feel rather woozy..."
  },
  "pondskater": {
    "id": 38,
    "fileName": "pondskater",
    "name": {
      "name-en": "Pondskater",
      "name-cn": "水黾",
      "name-de": "Wasserläufer",
      "name-sp": "Zapatero",
      "name-fr": "Patineur",
      "name-it": "Gerride",
      "name-jp": "アメンボ",
      "name-kr": "소금쟁이",
      "name-nl": "Schaatsenrijder",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "5-9",
  ...
  "diving_beetle": {
    ...
    "name": {
      "name-en": "Diving beetle",
      "name-cn": "龙虱",
      "name-de": "Schwimmkäfer",
      "name-sp": "Escarabajo nadador",
      "name-fr": "Dytique",
      "name-it": "Ditisco",
      "name-jp": "ゲンゴロウ",
      "name-kr": "물방개",
      "name-nl": "Waterroofkever",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "5-9",
  ...
  "giant_water_bug": {
    ...
    "name": {
      "name-en": "Giant water bug",
      "name-cn": "田鳖",
      "name-de": "Riesenwanze",
      "name-sp": "Chinche acuática gigante",
      "name-fr": "Punaise d'eau géante",
      "name-it": "Cimice d'acqua gigante",
      "name-jp": "タガメ",
      "name-kr": "물장군",
      "name-nl": "Reuzenwaterwants",
      "name-ru": "Водяной клоп-гигант"
    },
    "availability": {
      "monthNorthern": "4-9",
      "monthSouthern": "10-3",
  ...
  "man-faced_stink_bug": {
    ...
    "name": {
      "name-en": "Man-faced stink bug",
      "name-cn": "人面椿象",
      "name-de": "Gesichtswanze",
      "name-sp": "Chinche con rostro humano",
      "name-fr": "Catacanthus",
      "name-it": "Catacanthus",
      "name-jp": "ジンメンカメムシ",
      "name-kr": "인면노린재",
      "name-nl": "Gezichtschildwants",
      "name-ru": "Щитник с лицом"
    },
    "availability": {
      "monthNorthern": "3-10",
      "monthSouthern": "9-4",
  ...
  "ladybug": {
    ...
    "name": {
      ...
      "name-jp": "テントウムシ",
      "name-kr": "무당벌레",
      "name-nl": "Lieveheersbeestje",
      "name-ru": "Божья коровка"
    },
    "availability": {
      "monthNorthern": "3-6 & 10",
      "monthSouthern": "9-12 & 4",
      "time": "8am - 5pm",
      "isAllDay": false,
      "isAllYear": false,
      "location": "On flowers",
  ...
  "tiger_beetle": {
    ...
    "name": {
      "name-en": "Tiger beetle",
      "name-cn": "虎甲虫",
      "name-de": "Sandlaufkäfer",
      "name-sp": "Escarabajo tigre",
      "name-fr": "Cicindèle",
      "name-it": "Cicindela",
      "name-jp": "ハンミョウ",
      "name-kr": "길앞잡이",
      "name-nl": "Zandloopkever",
      "name-ru": "Жук-скакун"
    },
    "availability": {
      "monthNorthern": "2-11",
  ...
  "jewel_beetle": {
    ...
    "name": {
      "name-en": "Jewel beetle",
      "name-cn": "吉丁虫",
      "name-de": "Prachtkäfer",
      "name-sp": "Escarabajo joya",
      "name-fr": "Bupreste",
      "name-it": "Stigmodera",
      "name-jp": "タマムシ",
      "name-kr": "비단벌레",
  ...
  "violin_beetle": {
    ...
    "name": {
      "name-en": "Violin beetle",
      "name-cn": "提琴虫",
      "name-de": "Geigenkäfer",
      "name-sp": "Escarabajo violín",
      "name-fr": "Mormolyce",
      "name-it": "Carabo violino",
      "name-jp": "バイオリンムシ",
      "name-kr": "바이올린벌레",
      "name-nl": "Vioolkever",
      "name-ru": "Unknown"
    ...
    "availability": {
      "monthNorthern": "5-6 & 9-11",
      "monthSouthern": "3-5 & 11-12",
      "time": "",
      "isAllDay": true,
      "isAllYear": false,
      "location": "On tree stumps",
  ...
  "citrus_long-horned_beetle": {
    ...
    "name": {
      "name-en": "Citrus long-horned beetle",
      "name-cn": "星天牛",
      "name-de": "Fichtenbock",
      "name-sp": "Longicornio asiático",
      "name-fr": "Capricorne des agrumes",
      "name-it": "Tarlo asiatico",
      "name-jp": "ゴマダラカミキリ",
      "name-kr": "알락하늘소",
      "name-nl": "Aziatische boktor",
      "name-ru": "Цитрусовый усач"
    },
    "availability": {
      "monthNorthern": "",
      "monthSouthern": "",
  ...
  "rosalia_batesi_beetle": {
    ...
    "name": {
      "name-en": "Rosalia batesi beetle",
      "name-cn": "琉璃星天牛",
      "name-de": "Alpenbock",
      "name-sp": "Escarabajo rosalia batesi",
      "name-fr": "Rosalia batesi",
      "name-it": "Coleottero rosalia batesi",
      "name-jp": "ルリボシカミキリ",
      "name-kr": "루리하늘소",
      "name-nl": "Alpenboktor",
      "name-ru": "Unknown"
  ...
  "blue_weevil_beetle": {
    ...
    "name": {
      "name-en": "Blue weevil beetle",
      "name-cn": "宝石象鼻虫",
      "name-de": "Blaurüsselkäfer",
      "name-sp": "Gorgojo azul",
      "name-fr": "Charançon bleu",
      "name-it": "Coleottero Schoenherr",
      "name-jp": "ホウセキゾウムシ",
      "name-kr": "유포루스바구미",
      "name-nl": "Blauwe snuitkever",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-8",
  ...
  "dung_beetle": {
    ...
    "name": {
      ...
      "name-cn": "蜣螂",
      "name-de": "Mistkäfer",
      "name-sp": "Escarabajo pelotero",
      "name-fr": "Bousier",
      "name-it": "Scarabeo stercorario",
      "name-jp": "フンコロガシ",
      "name-kr": "쇠똥구리",
      "name-nl": "Mestkever",
      "name-ru": "Unknown"
  ...
  "earth-boring_dung_beetle": {
    ...
    "name": {
      "name-en": "Earth-boring dung beetle",
      "name-cn": "雪隐金龟",
      "name-de": "Gold-Mistkäfer",
      "name-sp": "Escarabajo geotrúpido",
      "name-fr": "Geotrupidae",
      "name-it": "Geotrupidae",
      "name-jp": "オオセンチコガネ",
      "name-kr": "보라금풍뎅이",
      "name-nl": "Echte mestkever",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-9",
  ...
  "scarab_beetle": {
    ...
    "name": {
      "name-en": "Scarab beetle",
      "name-cn": "宝石金龟",
      "name-de": "Goldskarabäus",
      "name-sp": "Escarabajo oro",
      "name-fr": "Scarabée",
      "name-it": "Chrysina resplendens",
      "name-jp": "プラチナコガネ",
      "name-kr": "보석풍뎅이",
      "name-nl": "Scarabee",
      "name-ru": "Unknown"
  ...
  "drone_beetle": {
    ...
    "name": {
      "name-en": "Drone beetle",
      "name-cn": "日铜锣花金龟",
      "name-de": "Japan-Rosenkäfer",
      "name-sp": "Escarabajo verde japonés",
      "name-fr": "Pseudotorynorrhina",
      "name-it": "Cetonia dorata",
      "name-jp": "カナブン",
      "name-kr": "풍이",
      "name-nl": "Bladsprietkever",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "6-8",
  ...
  "goliath_beetle": {
    ...
    "name": {
      "name-en": "Goliath beetle",
      "name-cn": "歌利亚大角花金龟",
      "name-de": "Goliathkäfer",
      "name-sp": "Goliat",
      "name-fr": "Scarabée Goliath",
      "name-it": "Scarabeo Golia",
      "name-jp": "ゴライアスオオツノハナムグリ",
      "name-kr": "골리앗왕꽃무지",
      "name-nl": "Goliathkever",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "6-9",
  ...
  "saw_stag": {
    ...
    "name": {
      "name-en": "Saw_stag",
      "name-cn": "锯锹形虫",
      "name-de": "Sägezahn-Hirschkäfer",
      "name-sp": "Escarabajo ciervo sierra",
      "name-fr": "Lucane inclinatus",
      "name-it": "Coleottero cervo",
      "name-jp": "ノコギリクワガタ",
      "name-kr": "톱사슴벌레",
      "name-nl": "Zaaghertkever",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-8",
  ...
  "miyama_stag": {
    ...
    "name": {
      ...
      "name-cn": "深山锹形虫",
      "name-de": "Hirschkäfer",
      "name-sp": "Escarabajo ciervo Miyama",
      "name-fr": "Lucane miyama",
      "name-it": "Coleottero lucanide",
      "name-jp": "ミヤマクワガタ",
      "name-kr": "사슴벌레",
      "name-nl": "Miyama-hertkever",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-8",
  ...
  "giant_stag": {
    ...
    "name": {
      "name-en": "Giant stag",
      "name-cn": "大锹形虫",
      "name-de": "Riesen-Hirschkäfer",
      "name-sp": "Escarabajo ciervo gigante",
      "name-fr": "Lucane cerf-volant",
      "name-it": "Coleottero gigante",
      "name-jp": "オオクワガタ",
      "name-kr": "왕사슴벌레",
      "name-nl": "Reuzenhertkever",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-8",
  ...
  "rainbow_stag": {
    ...
    "name": {
      "name-en": "Rainbow stag",
      "name-cn": "彩虹锹形虫",
      "name-de": "Pracht-Hirschkäfer",
      "name-sp": "Escarabajo ciervo arcoíris",
      "name-fr": "Lucane copris irisé",
      "name-it": "Coleottero arcobaleno",
      "name-jp": "ニジイロクワガタ",
      "name-kr": "뮤엘러리사슴벌레",
      "name-nl": "Regenbooghertkever",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "6-9",
  ...
  "cyclommatus_stag": {
    ...
    "name": {
      "name-en": "Cyclommatus stag",
      "name-cn": "细身赤锹形虫",
      "name-de": "Cyclommatus",
      "name-sp": "Esc. ciervo cyclommatus",
      "name-fr": "Lucane cyclommatus",
      "name-it": "Coleottero cyclommatus",
      "name-jp": "ホソアカクワガタ",
      "name-kr": "엘라푸스가위사슴벌레",
      "name-nl": "Vliegend hert",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-8",
  ...
  "golden_stag": {
    ...
    "name": {
      "name-en": "Golden stag",
      "name-cn": "黄金鬼锹形虫",
      "name-de": "Allotopus rosenbergi",
      "name-sp": "Escarabajo ciervo tornasol",
      "name-fr": "Lucane lamprima",
      "name-it": "Coleottero dorato",
      "name-jp": "オウゴンオニクワガタ",
      "name-kr": "황금사슴벌레",
      "name-nl": "Gouden hertkever",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-8",
  ...
  "giraffe_stag": {
    ...
    "name": {
      "name-en": "Giraffe stag",
      "name-cn": "长颈鹿锯锹形虫",
      "name-de": "Giraffenhirschkäfer",
      "name-sp": "Escarabajo ciervo jirafa",
      "name-fr": "Lucane girafe",
      "name-it": "Coleottero giraffa",
      "name-jp": "ギラファノコギリクワガタ",
      "name-kr": "기라파톱사슴벌레",
      "name-nl": "Girafhertkever",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-8",
  ...
  "horned_dynastid": {
    ...
    "name": {
      "name-en": "Horned dynastid",
      "name-cn": "独角仙",
      "name-de": "Nashornkäfer",
      "name-sp": "Escarabajo astado japonés",
      "name-fr": "Scarabée kabuto",
      "name-it": "Scarabeo kabutomushi",
      "name-jp": "カブトムシ",
      "name-kr": "장수풍뎅이",
      "name-nl": "Neushoornkever",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-8",
  ...
  "horned_atlas": {
    ...
    "name": {
      "name-en": "Horned atlas",
      "name-cn": "高卡萨斯南洋大兜虫",
      "name-de": "Atlaskäfer",
      "name-sp": "Escarabajo astado atlas",
      "name-fr": "Scarabée Atlas",
      "name-it": "Scarabeo atlas",
      "name-jp": "コーカサスオオカブト",
      "name-kr": "코카서스장수풍뎅이",
      "name-nl": "Atlaskever",
      "name-ru": "Unknown"
  ...
  "horned_elephant": {
    ...
    "name": {
      "name-en": "Horned elephant",
      "name-cn": "象兜虫",
      "name-de": "Elefantenkäfer",
      "name-sp": "Escarabajo astado elefante",
      "name-fr": "Scarabée éléphant",
      "name-it": "Scarabeo elefante",
      "name-jp": "ゾウカブト",
      "name-kr": "코끼리장수풍뎅이",
      "name-nl": "Olifantkever",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-8",
  ...
  "horned_hercules": {
    ...
    "name": {
      "name-en": "Horned hercules",
      "name-cn": "长戟大兜虫",
      "name-de": "Herkuleskäfer",
      "name-sp": "Escarabajo astado hércules",
      "name-fr": "Scarabée Hercule",
      "name-it": "Scarabeo Ercole",
      "name-jp": "ヘラクレスオオカブト",
      "name-kr": "헤라클레스장수풍뎅이",
      "name-nl": "Herculeskever",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-8",
  ...
  "walking_stick": {
    ...
    "name": {
      "name-en": "Walking stick",
      "name-cn": "竹节虫",
      "name-de": "Stabschrecke",
      "name-sp": "Insecto palo",
      "name-fr": "Phasme",
      "name-it": "Insetto stecco",
      "name-jp": "ナナフシ",
      "name-kr": "긴수염대벌레",
      "name-nl": "Wandelende tak",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-11",
  ...
  "walking_leaf": {
    ...
    "name": {
      "name-en": "Walking leaf",
      "name-cn": "叶竹节虫",
      "name-de": "Blattschrecke",
      "name-sp": "Insecto hoja",
      "name-fr": "Phyllie",
      "name-it": "Insetto foglia",
      "name-jp": "コノハムシ",
      "name-kr": "잎사귀벌레",
      "name-nl": "Wandelend blad",
      "name-ru": "Unknown"
    },
    "availability": {
      "monthNorthern": "7-9",
  ...
  "bagworm": {
    ...
    "name": {
      ...
      "name-cn": "蓑衣虫",
      "name-de": "Sackträger",
      "name-sp": "Oruga de bolsón",
      "name-fr": "Psyché",
      "name-it": "Bruco dal fodero",
      "name-jp": "ミノムシ",
      "name-kr": "도롱이벌레",
      "name-nl": "Zakjesdrager",
      "name-ru": "Мешочница"
    },
    "availability": {
      "monthNorthern": "",
  ...
  "hermit_crab": {
    ...
    "name": {
      "name-en": "Hermit crab",
      "name-cn": "寄居蟹",
      "name-de": "Einsiedlerkrebs",
      "name-sp": "Cangrejo ermitaño",
      "name-fr": "Bernard-l'ermite",
      "name-it": "Granchio paguro",
      "name-jp": "ヤドカリ",
      "name-kr": "소라게",
      "name-nl": "Heremietkreeft",
      "name-ru": "Рак-отшельник"
    },
    "availability": {
      "monthNorthern": "",
      "monthSouthern": "",
  ...
  "wharf_roach": {
    ...
    "name": {
      "name-en": "Wharf roach",
      "name-cn": "海蟑螂",
      "name-de": "Ligia exotica",
      "name-sp": "Cochinilla de arena",
      "name-fr": "Ligie",
      "name-it": "Ligia exotica",
      "name-jp": "フナムシ",
      "name-kr": "갯강구",
      "name-nl": "Strandpissebed",
      "name-ru": "Морской таракан"
    },
    "availability": {
      "monthNorthern": "",
      "monthSouthern": "",
  ...
  "centipede": {
    ...
    "name": {
      "name-en": "Centipede",
      "name-cn": "蜈蚣",
      "name-de": "Hundertfüßer",
      "name-sp": "Ciempiés",
      "name-fr": "Mille-pattes",
      "name-it": "Centopiedi",
      "name-jp": "ムカデ",
      "name-kr": "지네",
      "name-nl": "Duizendpoot",
